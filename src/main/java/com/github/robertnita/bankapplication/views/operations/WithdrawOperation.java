package com.github.robertnita.bankapplication.views.operations;
...
public class WithdrawOperation extends javax.swing.JDialog {
    ...
    private void btnWithdrawActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnWithdrawActionPerformed
        ...
        if(operationCtrl.makeWithdraw(accountNumber, amount)) {
            JOptionPane.showMessageDialog(this, "Withdrawal was made successfully!", "Withdrawal", JOptionPane.INFORMATION_MESSAGE);
        } else {
            JOptionPane.showMessageDialog(this, "Insufficient funds!", "Withdrawal", JOptionPane.ERROR_MESSAGE);
        }
        this.dispose();
